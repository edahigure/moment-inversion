...
gg=(struct GREEN *)malloc(sizeof(struct GREEN)*(nsta));
  ...
  for(i=0 ; i < nsta ; i++)
   ...
   ss[i].t=(float *)malloc(sizeof(float)*vsize);
   ss[i].r=(float *)malloc(sizeof(float)*vsize);
   ss[i].z=(float *)malloc(sizeof(float)*vsize);
   ...
   gg[i].u1=(float *)malloc(sizeof(float)*vsize);
   gg[i].u2=(float *)malloc(sizeof(float)*vsize);
   gg[i].u3=(float *)malloc(sizeof(float)*vsize);
   gg[i].u4=(float *)malloc(sizeof(float)*vsize);
   gg[i].u5=(float *)malloc(sizeof(float)*vsize);
   gg[i].u6=(float *)malloc(sizeof(float)*vsize);
   gg[i].u7=(float *)malloc(sizeof(float)*vsize);
   gg[i].u8=(float *)malloc(sizeof(float)*vsize);
...
fitcheck(ss,gg,W,Strike,Rake,Dip,Mo,nsta,isoflag,&E,&VR);  /*Function to compute vr and flag bad stations*/
